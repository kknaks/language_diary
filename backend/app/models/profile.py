...
class UserProfile(Base):
    ...
    pronunciation_voice_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("voices.id"), nullable=True)
    empathy: Mapped[int] = mapped_column(Integer, server_default="50", nullable=False)
    intuition: Mapped[int] = mapped_column(Integer, server_default="50", nullable=False)
    logic: Mapped[int] = mapped_column(Integer, server_default="50", nullable=False)
    ...
    pronunciation_voice = relationship("Voice", foreign_keys=[pronunciation_voice_id])

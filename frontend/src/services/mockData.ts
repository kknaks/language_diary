...
export const mockDiaries: Diary[] = [
  {
    ...
    status: 'completed',
    learning_cards: [
      { id: 1, card_type: 'phrase', content_en: 'pull it off', content_ko: '해내다, 성공하다', example_en: 'I think we can pull it off if we work together.', example_ko: '함께하면 해낼 수 있을 거야.', cefr_level: 'B1', part_of_speech: 'phrasal verb', card_order: 0 },
      { id: 2, card_type: 'word', content_en: 'deadline', content_ko: '마감일', example_en: 'The deadline for the report is next Friday.', example_ko: '보고서 마감일은 다음 주 금요일이야.', cefr_level: 'A2', part_of_speech: 'noun', card_order: 1 },
      { id: 3, card_type: 'sentence', content_en: 'It\'s going to be tight', content_ko: '빡빡할 거야', example_en: 'We have a lot to do — it\'s going to be tight.', example_ko: '할 일이 많아서 빡빡할 거야.', cefr_level: 'B1', part_of_speech: null, card_order: 2 },
    ],
    created_at: day(0),
    updated_at: day(0),
    completed_at: day(0),
  },
  {
    ...
    learning_cards: [
      { id: 4, card_type: 'phrase', content_en: 'meet up with', content_ko: '~와 만나다', example_en: 'Let\'s meet up with the others after work.', example_ko: '퇴근 후에 다른 사람들과 만나자.', cefr_level: 'A2', part_of_speech: 'phrasal verb', card_order: 0 },
      { id: 5, card_type: 'word', content_en: 'enjoyable', content_ko: '즐거운', example_en: 'The trip was very enjoyable.', example_ko: '여행이 매우 즐거웠다.', cefr_level: 'A2', part_of_speech: 'adjective', card_order: 1 },
    ],
    created_at: day(1),
    updated_at: day(1),
    completed_at: day(1),
  },
  {
    ...
    status: 'completed',
    learning_cards: [
      { id: 6, card_type: 'word', content_en: 'relax', content_ko: '쉬다, 긴장을 풀다', example_en: 'I like to relax on the couch after work.', example_ko: '퇴근 후에 소파에서 쉬는 걸 좋아해.', cefr_level: 'A1', part_of_speech: 'verb', card_order: 0 },
    ],
    created_at: day(3),
    updated_at: day(3),
    completed_at: day(3),
  },
  {
    ...
    status: 'completed',
    learning_cards: [
      { id: 7, card_type: 'phrase', content_en: 'turn out', content_ko: '결과가 ~하다', example_en: 'The party turned out to be a great success.', example_ko: '파티는 대성공이었다.', cefr_level: 'B1', part_of_speech: 'phrasal verb', card_order: 0 },
      { id: 8, card_type: 'word', content_en: 'recipe', content_ko: '레시피, 조리법', example_en: 'This is my grandmother\'s secret recipe.', example_ko: '이건 할머니의 비밀 레시피야.', cefr_level: 'A2', part_of_speech: 'noun', card_order: 1 },
    ],
    created_at: day(3),
    updated_at: day(3),
    completed_at: day(3),
  },
  {
    ...
    status: 'learning_done',
    learning_cards: [
      { id: 9, card_type: 'word', content_en: 'bloom', content_ko: '피다, 꽃이 피다', example_en: 'The flowers bloom every spring.', example_ko: '꽃은 매년 봄에 핀다.', cefr_level: 'B1', part_of_speech: 'verb', card_order: 0 },
      { id: 10, card_type: 'phrase', content_en: 'go for a walk', content_ko: '산책하다', example_en: 'Let\'s go for a walk after dinner.', example_ko: '저녁 후에 산책하자.', cefr_level: 'A1', part_of_speech: 'phrase', card_order: 1 },
    ],
    created_at: day(5),
    updated_at: day(5),
    completed_at: day(5),
  },
  {
    ...
    status: 'completed',
    learning_cards: [
      { id: 11, card_type: 'word', content_en: 'overtime', content_ko: '초과 근무', example_en: 'I worked overtime three days this week.', example_ko: '이번 주에 3일 야근했다.', cefr_level: 'A2', part_of_speech: 'noun', card_order: 0 },
      { id: 12, card_type: 'word', content_en: 'exhausted', content_ko: '기진맥진한', example_en: 'After the marathon, I was completely exhausted.', example_ko: '마라톤 후에 완전히 지쳤다.', cefr_level: 'B1', part_of_speech: 'adjective', card_order: 1 },
    ],
    created_at: day(7),
    updated_at: day(7),
    completed_at: day(7),
  },
  {
    ...
    status: 'learning_done',
    learning_cards: [
      { id: 13, card_type: 'phrase', content_en: 'for the first time in a while', content_ko: '오랜만에', example_en: 'I saw an old friend for the first time in a while.', example_ko: '오랜만에 옛 친구를 만났다.', cefr_level: 'B1', part_of_speech: 'phrase', card_order: 0 },
    ],
    created_at: day(10),
    updated_at: day(10),
    completed_at: day(10),
  },
  {
    ...
    status: 'completed',
    learning_cards: [
      { id: 14, card_type: 'word', content_en: 'tough', content_ko: '힘든, 어려운', example_en: 'The exam was really tough.', example_ko: '시험이 정말 어려웠다.', cefr_level: 'A2', part_of_speech: 'adjective', card_order: 0 },
      { id: 15, card_type: 'phrase', content_en: 'felt good afterwards', content_ko: '끝나고 기분이 좋았다', example_en: 'I was tired, but I felt good afterwards.', example_ko: '피곤했지만 끝나고 기분이 좋았다.', cefr_level: 'B1', part_of_speech: 'phrase', card_order: 1 },
    ],
    created_at: day(14),
    updated_at: day(14),
    completed_at: day(14),

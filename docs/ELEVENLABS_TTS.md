...
<AccordionGroup>
  <Accordion title="Creating your AWS credentials">
    ...
    <Frame caption="AWS Console Login">
      <img src="file:dac93c81-f810-4395-9653-b298832fd02a" />
    </Frame>
    ...
    <Frame caption="AWS IAM Dashboard">
      <img src="file:3460780d-2e5b-4477-9e17-da68348c7c04" />
    </Frame>
    ...
    <Frame caption="Add AWS IAM User">
      <img src="file:442bb57d-895c-411d-b457-fcd3168afa78" />
    </Frame>
    ...
    <Frame caption="Set Permission for AWS IAM User">
      <img src="file:18ce42ce-b80e-420f-8c9b-987909e54efe" />
    </Frame>
    ...
    <Frame caption="AWS Access Secret Key">
      <img src="file:46315a4d-8591-49bb-9c21-199d0b369391" />
    </Frame>

    6. Get AWS region name: ex. us-east-1

    <Frame caption="AWS Region Name">
      <img src="file:fb23e411-2b01-42c1-9e0b-7c2c9a44dd68" />
    </Frame>
    ...
    <Frame caption="Enter a New S3 Bucket Name">
      <img src="file:2241b660-42b0-4e5e-a7f0-d203d1abba0e" />
    </Frame>

    <Frame caption="S3 Bucket List">
      <img src="file:a0cf795e-24b7-4c31-bfe3-b424ea702df5" />
    </Frame>
  </Accordion>
